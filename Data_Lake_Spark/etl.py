...
def process_song_data(spark, input_data, output_data):
    ...
    songs_table.write.parquet(output_data + 'songs_table.parquet', partitionBy = ('year','artist_id'), mode='overwtite')
...
def process_log_data(spark, input_data, output_data):
    ...
    # read log data file
    df = df.select('userId','firstName','lastName','gender','level').show()
